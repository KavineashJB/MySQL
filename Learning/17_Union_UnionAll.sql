...
SELECT * from employees union ALL SELECT * FROM contractors;
...
-- when you see the column name, it's same as the column name of the first row
select employee_id, first_name from employees
UNION
SELECT contractor_id, last_name from contractors
UNION
